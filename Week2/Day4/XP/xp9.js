...
// cost calculators:
function hotelCost() {
    return (CostNight * getNum("Please enter how many nights:"))
}

function planeRideCost() {
    let destination = getStr("Please enter a destination:").toLowerCase();
    if (flightCost[destination]) { //this line maybe not needed as I am checking user entry. 
        return flightCost[destination]
